...
favicon:
	inkscape -f $(APPICON_SRC)/favicon.svg -w 16 -b $(APPICON_COLOR) -e $(APPICON_DIST)/favicon-16x16.png
	inkscape -f $(APPICON_SRC)/favicon.svg -w 32 -b $(APPICON_COLOR) -e $(APPICON_DIST)/favicon-32x32.png
	inkscape -f $(APPICON_SRC)/app-icon.svg -w 96 -b $(APPICON_COLOR) -e $(APPICON_DIST)/favicon-96x96.png
	inkscape -f $(APPICON_SRC)/app-icon.svg -w 160 -b $(APPICON_COLOR) -e $(APPICON_DIST)/favicon-160x160.png
	inkscape -f $(APPICON_SRC)/app-icon.svg -w 196 -b $(APPICON_COLOR) -e $(APPICON_DIST)/favicon-196x196.png
